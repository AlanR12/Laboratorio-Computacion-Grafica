...
int main() {
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Proyecciones y transformaciones basicas - Alan Robles", nullptr, nullptr);
	...
	//Verificacion de errores de inicializaci�n de glew
 ...
 //     
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//cámara en el mundo 3D.
		view = glm::translate(view, glm::vec3(0.0f, -0.2f, -3.5f));

		//Primer Cubo - Amarillo
